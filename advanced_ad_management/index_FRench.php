...
*/
   ...
   function adManage_install () {
      ...
      osc_set_preference('adManageed_payperpost', '0', 'plugin-item_adManage', 'INTEGER');
      ...
      $conn->osc_dbExec("INSERT IGNORE INTO %st_pages_description (fk_i_pages_id, fk_c_locale_code, s_title, s_text) VALUES (%d, '%s', '{WEB_TITLE} - Rappel: Votre annonce {ITEM_TITLE} va bientôt expirer.', '<p>Bonjour {CONTACT_NAME},</p>\r\n<p> </p>\r\n<p>Votre annonce est sur le point d'expirer. Vous pouvez simplement la renouveller en 1 clic , click on the link if you would like to extend your ad {REPUBLISH_URL}</p><p> </p>\r\n<p>Note: ceci est un message automatique de rappel. Pour toutes questions, connectez vous à votre Tableau de Bord privé.</p>\r\n<p> </p>\r\n<p>Merci et Bonne Journée à vous!</p>\r\n<p>{WEB_TITLE}</p>')", DB_TABLE_PREFIX, $conn->get_last_id(), osc_language());
      ...
      $conn->osc_dbExec("INSERT IGNORE INTO %st_pages_description (fk_i_pages_id, fk_c_locale_code, s_title, s_text) VALUES (%d, '%s', '{WEB_TITLE} - Action requise: Votre annonce {ITEM_TITLE} vient d'expirer.', '<p>Bonjour {CONTACT_NAME},</p>\r\n<p> </p>\r\n<p>Votre annonce est arrivée à expiration. Mais vous pouvez la renouveller en cliquant simplement sur ce lien: {REPUBLISH_URL}. Sans action de votre part, votre annonce sera automatquement supprimée dans {PERM_DELETED} jours</p><p> </p>\r\n<p>Note: ceci est un message automatique de rappel. Pour toutes questions, connectez vous à votre Tableau de Bord privé.</p>\r\n<p> </p>\r\n<p>Merci et Bonne Journée à vous!</p>\r\n<p>{WEB_TITLE}</p>')", DB_TABLE_PREFIX, $conn->get_last_id(), osc_language()); 
   }
